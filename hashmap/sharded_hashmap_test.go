...
func TestShardedHashMap_SetAndGet(t *testing.T) {
	t.Run("добавление и получение элементов", func(t *testing.T) {
		m := NewShardedHashMap[string, int]()
...
func TestShardedHashMap_GetMissing(t *testing.T) {
	t.Run("получение несуществующего ключа", func(t *testing.T) {
		m := NewShardedHashMap[string, int]().Set("one", 1)
...
func TestShardedHashMap_Overwrite(t *testing.T) {
	t.Run("перезапись существующего ключа", func(t *testing.T) {
		m1 := NewShardedHashMap[string, int]().Set("key", 1)
		m2 := m1.Set("key", 100)
...
func TestShardedHashMap_Persistence(t *testing.T) {
	t.Run("Set создаёт новую версию", func(t *testing.T) {
		m1 := NewShardedHashMap[string, int]()
		m2 := m1.Set("a", 1)
		m3 := m2.Set("b", 2)
		m4 := m3.Set("c", 3)
...
func TestShardedHashMap_Delete(t *testing.T) {
	t.Run("удаление существующего ключа", func(t *testing.T) {
		m := NewShardedHashMap[string, int]().Set("a", 1).Set("b", 2).Set("c", 3)
	...
	t.Run("удаление несуществующего ключа", func(t *testing.T) {
		m := NewShardedHashMap[string, int]().Set("a", 1)
...
func TestShardedHashMap_IntKeys(t *testing.T) {
	t.Run("целочисленные ключи", func(t *testing.T) {
		m := NewShardedHashMap[int, string]()
...
func TestShardedHashMap_LargeDataset(t *testing.T) {
...
func TestShardedHashMap_Iterator(t *testing.T) {
...
func TestShardedHashMap_Keys(t *testing.T) {
	t.Run("итерация по ключам", func(t *testing.T) {
		m := NewShardedHashMap[string, int]().Set("a", 1).Set("b", 2)
...
func TestShardedHashMap_Values(t *testing.T) {
...
func TestShardedHashMap_NestedStructures(t *testing.T) {
	t.Run("хранение векторов в качестве значений", func(t *testing.T) {
		inner := array.NewVector[int]().Append(1).Append(2).Append(3)
		m := NewShardedHashMap[string, *array.Vector[int]]().Set("numbers", inner)
...
func TestShardedHashMap_Contains(t *testing.T) {
	t.Run("проверка наличия ключа", func(t *testing.T) {
		m := NewShardedHashMap[string, int]().Set("exists", 1)
